...
headers = {
    ...
    'DNT': '1',
    'Referer': 'https://ria.ru/amp/location_Moskva/',
...
@dataclass
class MoscowParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.MOSCOW
    name: str = 'moscow'
    __base_url = 'https://ria.ru'
    __news_url = __base_url + '/amp/location_Moskva/more.json'
    referer = 'https://ria.ru/amp/location_Moskva/'
