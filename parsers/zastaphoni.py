...
@dataclass
class ZastaphoniParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.ZASTAPHONI
    name: str = 'zastaphoni'
    __base_url: str = 'https://sputnik-georgia.ru'
    __news_url: str = 'https://sputnik-georgia.ru/georgia/'
    referer: str = 'https://sputnik-georgia.ru/georgia/'
