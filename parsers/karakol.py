...
@dataclass
class KarakolParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.KARAKOL
    name: str = 'karakol'
    __base_url = 'https://karakol-t.turmush.kg'
    __news_url = 'https://karakol-t.turmush.kg/'
    referer = 'https://karakol-t.turmush.kg/'
