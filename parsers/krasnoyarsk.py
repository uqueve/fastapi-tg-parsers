...
@dataclass
class KrasnoyarskParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.KRASNOYARSK
    name: str = 'krasnoyarsk'
    __base_url: str = 'https://ngs24.ru'
    __news_url: str = 'https://ngs24.ru/'
    referer: str = 'https://ngs24.ru/'
    # TODO: ddos-guard
    ...
    def find_title(self, soup: BeautifulSoup) -> str | None:
        title = soup.find('h1', class_='title_ip27z')
        if not title:
            return None
