...
@dataclass
class IvanovoParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.IVANOVO
    name: str = 'ivanovo'
    __base_url: str = 'https://ivteleradio.ru'
    __news_url: str = 'https://ivteleradio.ru/news'
    referer: str = 'https://ivteleradio.ru/news'
    ...
    def find_photos(self, soup: BeautifulSoup) -> list:
        photos = []
        image_div = soup.find('img', class_='newsitem_image')
        if image_div:
