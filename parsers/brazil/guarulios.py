...
class GuaruliosParser(BaseParser):
    ...
    name: str = 'guarulios'
    __base_url: str = 'https://guarulhosweb.com.br'
    __news_url: str = 'https://guarulhosweb.com.br/'
    referer: str = 'https://guarulhosweb.com.br/'
    ...
    def find_body(self, soup: BeautifulSoup) -> str | None:
        body = ''
        mm = soup.find('div', class_='entry-content herald-entry-content')
        ps = mm.find_all('p')
        for p in ps:
...
async def test() -> None:
    ...
    parser = GuaruliosParser(request_object=request_obj)
