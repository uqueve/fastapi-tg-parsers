...
headers = {
    ...
    'DNT': '1',
    'Referer': 'https://ria.ru/amp/location_Sankt_Peterburg/',
...
@dataclass
class SanktPiterParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.SANKT_PETERBURG
    name: str = 'omsk'
    __base_url = 'https://ria.ru'
    __news_url = __base_url + '/amp/location_Sankt_Peterburg/more.json'
    referer = 'https://ria.ru/amp/location_Sankt_Peterburg/'
