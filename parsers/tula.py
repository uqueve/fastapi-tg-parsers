...
headers = {
    ...
    'DNT': '1',
    'Referer': 'https://ria.ru/amp/location_Tula/',
...
@dataclass
class TulaParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.TULA
    name: str = 'tula'
    __base_url = 'https://ria.ru'
    __news_url = __base_url + '/amp/location_Tula/more.json'
    referer = 'https://ria.ru/amp/location_Tula/'
