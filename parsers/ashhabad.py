...
headers = {
    ...
    'DNT': '1',
    'Referer': 'https://ria.ru/amp/location_Ashgabat/',
...
@dataclass
class AshhabadParser(BaseParser):
    request_object: BaseRequest
    city: SiteModel = SiteModel.ASHHABAD
    name: str = 'ashhabad'
    __base_url = 'https://ria.ru'
    __news_url = __base_url + '/amp/location_Ashgabat/more.json'
    referer = 'https://ria.ru/amp/location_Ashgabat/'
...
async def test() -> None:
    req_obj = BaseRequest()
    parser = AshhabadParser(request_object=req_obj)
