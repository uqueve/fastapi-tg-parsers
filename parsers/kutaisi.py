...
@dataclass
class KutaisiParser(BaseParser, BaseRequest):
    city: SiteModel = SiteModel.KUTAISI
    name: str = 'kutaisi'
    __base_url: str = 'https://sputnik-georgia.ru'
    __news_url: str = 'https://sputnik-georgia.ru/geo_Kutaisi/'
    referer: str = 'https://sputnik-georgia.ru/geo_Kutaisi/'
